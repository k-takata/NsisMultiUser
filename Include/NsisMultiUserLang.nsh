...
!ifdef LANG_JAPANESE
	LangString MULTIUSER_PAGE_TITLE ${LANG_JAPANESE} "ユーザーの選択"
	LangString MULTIUSER_INSTALL_PAGE_SUBTITLE ${LANG_JAPANESE} "どのユーザー用に $(^NameDA) をインストールするかの選択。"
	LangString MULTIUSER_UNINSTALL_PAGE_SUBTITLE ${LANG_JAPANESE} "どのユーザー用に $(^NameDA) をアンインストールするかの選択。"
	LangString MULTIUSER_INSTALL_HEADER ${LANG_JAPANESE} "$(^NameDA) を全ユーザーと現在のユーザーのどちらにインストールするか選択してください。"
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_JAPANESE} "$(^NameDA) は全ユーザーと現在のユーザーの両方にインストールされています。$\r$\nどちらを削除するか選択してください。"
	LangString MULTIUSER_ALL_USERS ${LANG_JAPANESE} "このコンピュータを使う全員(&A) (all users)"
	LangString MULTIUSER_CURRENT_USER ${LANG_JAPANESE} "自分(&M) ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_JAPANESE} "このコンピュータを使う全員 (all users)"
	LangString MULTIUSER_CURRENT_USER_UMUI ${LANG_JAPANESE} "自分 ({USER})"
	LangString MULTIUSER_NEW_INSTALLATION_ALL_USERS ${LANG_JAPANESE} "全ユーザーに対して新規インストールします。"
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_JAPANESE} "現在のユーザーに対して新規インストールします。"
	LangString MULTIUSER_INSTALLED_ALL_USERS ${LANG_JAPANESE} "バージョン {VERSION} が $\"{FOLDER}$\" に全ユーザー用にインストールされています。"
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_JAPANESE} "バージョン {VERSION} が $\"{FOLDER}$\" に現在のユーザー用にインストールされています。"
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_JAPANESE} "{VERSION} を全ユーザーに対して再インストールします。"
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_JAPANESE} "{VERSION} を現在のユーザーに対して再インストールします。"
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_ALL_USERS ${LANG_JAPANESE} "バージョン {OLD_VERSION} をアンインストールし、バージョン {VERSION} を全ユーザーにインストールします。"
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_JAPANESE} "バージョン {OLD_VERSION} をアンインストールし、バージョン {VERSION} を現在のユーザーにインストールします。"
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_JAPANESE} "このプログラムは管理者として実行する必要があります。"
	LangString MULTIUSER_ADMIN_CREDENTIALS_REQUIRED ${LANG_JAPANESE} "管理者権限が必要です。"
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_JAPANESE} "アンインストールには管理者権限が必要です。"
	; error messages - not so important
	LangString MULTIUSER_INVALID_PARAMS ${LANG_JAPANESE} "不正なパラメーターの組み合わせです。"
	LangString MULTIUSER_NOT_INSTALLED ${LANG_JAPANESE} "$(^NameDA) はインストールされていません。"
	LangString MULTIUSER_INSTALLATION_FOR_CURRENT_USER_NOT_SUPPORTED ${LANG_JAPANESE} "現在のオペレーティングシステムは現在のユーザーに対するインストールをサポートしていません。"
	LangString MULTIUSER_ADMIN_ACCOUNT_LOGIN_REQUIRED ${LANG_JAPANESE} "続けるには管理者グループに属するアカウントでログインする必要があります。"
	LangString MULTIUSER_ELEVATION_NOT_SUPPORTED ${LANG_JAPANESE} "現在のオペレーティングシステムは昇格をサポートしていません。"
	LangString MULTIUSER_LOGON_SERVICE_NOT_RUNNING ${LANG_JAPANESE} "昇格できません。Secondary Logon サービスが動作していません。"
	LangString MULTIUSER_ELEVATION_ERROR ${LANG_JAPANESE} "昇格できません。エラー {ERROR}。"
!endif
